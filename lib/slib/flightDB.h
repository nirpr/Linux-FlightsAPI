...
class FlightDatabase
{
    ...
    void load_DB_from_folder(std::string &infoString, bool reRun = false) noexcept(false);
    bool load_db(const std::string &airportCode, std::string &infoString) noexcept(false);
