...
- Please make sure that the directory "flightsDB" is in the same directory as the makefile. (it should be automatic but just to make sure).
...
- after you'll enter "make clean" all the .out and .so files will be deleted.
